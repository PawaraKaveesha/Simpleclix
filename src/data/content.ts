...
export const team = [
  {
    ...
    description: 'Sets the vision, leads strategy, and ensures every project serves a business goal.',
    image: '/images/team/pawara.svg',
  ...
  },
  {
    name: 'Dev Fernando',
    role: 'Technical Lead',
    description: 'Owns architecture and engineering, keeping every build fast, secure, and scalable.',
    image: '/images/team/dev.svg',
    alt: 'Portrait of Dev Fernando',
    linkedin: 'https://linkedin.com',
  },
  {
    name: 'Amaya Silva',
    role: 'UI/UX Designer',
    description: 'Crafts interfaces and flows that feel effortless and look unmistakably premium.',
    image: '/images/team/amaya.svg',
    alt: 'Portrait of Amaya Silva',
    linkedin: 'https://linkedin.com',
  },
  {
    name: 'Rohan Perera',
    role: 'Digital Marketing Specialist',
    description: 'Runs SEO, paid media, and social strategies that turn presence into growth.',
    image: '/images/team/rohan.svg',
    alt: 'Portrait of Rohan Perera',
    linkedin: 'https://linkedin.com',
  },
];
